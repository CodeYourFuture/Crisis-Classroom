...
class Form extends React.Component {
  ...
  removeIngredientsHandler = (i, id) => {
    ...
    axios
    .post(`${process.env.REACT_APP_DOMAIN}/remove-ingredient`, { id: id })
    .then(result => {
      if (result) {
        ...
        <div>
          ...
          {this.state.ingredients &&
            this.state.ingredients.map(
              ({ id, ingredient_name, ingredient_image, ingredient_id }, i) => {
                return (
                  <div key={i}>
                    <div className="form-group">
                      <div className="lessonInput">
                        ...
                        <Button
                          ...
                          value="Remove"
                          onClick={() =>
                            this.removeIngredientsHandler(ingredient_id, id)
                          }
                        />
                      </div>
                    </div>
        ...
        <div className="template-form-btn">
          ...
          <div className="btn-right">
            <Button
              ...
              value="Next"
              onClick={() =>
                this.props.onAddIngredients(this.state.ingredients)
              }
            />
          </div>
        </div>
