...
class Form extends React.Component {
  ...
  removeToolsHandler = (i, id) => {
    ...
    axios
      .post(`${process.env.REACT_APP_DOMAIN}/remove-tool`, { id: id })
      .then(result => {
        if (result) {
      ...
      <div className="template-form">
        <div>
          <div>
            ...
            {this.state.tools &&
              this.state.tools.map(({ id, tool_name, tool_image, tool_id }, i) => {
                return (
                  <div key={i}>
                    <div className="form-group">
                      <div className="lessonInput">
                        ...
                        <Button
                          ...
                          value="Remove"
                          onClick={() => this.removeToolsHandler(tool_id, id)}
                        />
                      </div>
                    </div>
                  </div>
