            ...
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item dropdown tm">
                ...
                <ul className="dropdown-menu tr">
                  <li className="li"><a href="https://www.crisisclassroom.com/about/meet-the-team">Meet the team</a></li>
                  <li className="li"><a href="https://www.crisisclassroom.com/about/what-we-do">What we do</a></li>
                  <li className="li"><a href="https://www.crisisclassroom.com/about/our-supporters">Our supporters</a></li>
                </ul>
              </li>
