...
const HomePage = () => {
  return (
    <div className="getStart">
      ...
      />
      <h2 className="empower">EMPOWERMENT THROUGH EDUCATION FOR ALL REFUGEES</h2>
      <p>
              ...
              <figure className="thumbnail">
                <div className="img-container ">
                  <a href="https://www.crisisclassroom.com/projects/from-brighton-to-the-balkans" className="link-6">
                    <img src="https://www.crisisclassroom.com//media/files/MelissaAlon.jpg" alt="From Brighton to the Balkans" width="100%" className=" img-responsive day" /></a>
              ...
              <figure className="thumbnail">
                <div className="img-container">
                  <a href="https://www.crisisclassroom.com/projects/right-here-right-now" className="link-6">
                    <img src="https://www.crisisclassroom.com//media/files/P1030037.JPG" alt="Right Here Right Now" width="100%" className="img-responsive day" /></a>
              ...
              <figure className="thumbnail">
                <div className="img-container">
                  <a href="https://www.crisisclassroom.com/projects/fundraising-fridays" className="link-6">
                    <img src="https://www.crisisclassroom.com//media/files/Copy%20of%20IMG_7423.jpg" alt="Fundraising Fridays" width="100%" className="img-responsive day" /></a>
              ...
              <figure className="thumbnail">
                <div className="img-container">
                  <a href="https://www.crisisclassroom.com/projects/suzies-yard" className="link-6">
                    <img src="https://www.crisisclassroom.com//media/files/CRISIS-0094-2.jpg" alt="Suzie's Yard" width="100%" className="img-responsive day day-b" /></a>
              ...
              <figure className="thumbnail">
                <div className="img-container">
                  <a href="https://www.crisisclassroom.com/projects/supporting-refugees-with-their-further-education" className="link-6">
                    <img src="https://www.crisisclassroom.com//media/files/CRISIS-0131.jpg" alt="Supporting Refugees with their Further Education" width="100%" className="img-responsive day day-b" /></a>
