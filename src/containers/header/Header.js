    ...
    return (
      <div>
        <nav className="App-header sticky-top py-1">
          ...
          <div>
            <a
              href="https://www.facebook.com/CrisisClassroom/"
              className="nav-facebook"
            >
              <img
                src="https://www.crisisclassroom.com/img/icons/social/black/fbf.svg"
                alt="facebook"
                height="35"
              />
            </a>
            <a href="https://www.instagram.com/crisisclassroom/">
              <img
                src="https://www.crisisclassroom.com/img/icons/social/black/igf.svg"
                alt="instagram"
                height="35"
              />
            </a>
            <a href="https://mobile.twitter.com/Crisis_Classrm">
              <img
                src="https://www.crisisclassroom.com/img/icons/social/black/twf.svg"
                alt="tweeter"
                height="35"
              />
            </a>
          ...
          <div className="container d-flex flex-column flex-md-row justify-content-between">
            ...
            <a
              className="py-2 d-none d-md-inline-block"
              href="https://www.crisisclassroom.com/news"
            >
              News
            </a>
            <a
